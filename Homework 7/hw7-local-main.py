...
def run_local_directrunner():
    ...
    options.view_as(beam.options.pipeline_options.GoogleCloudOptions).job_name = "hw7-job-local"
    ...
    result_incoming = output_path + "local_result_incoming.txt"
    result_outgoing = output_path + "local_result_outgoing.txt"
